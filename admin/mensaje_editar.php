			...
			<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main col-md-12">			
				...
				<?php 
					...
					if($codigo){
						...
						$sql = "SELECT * FROM tb_mensaje WHERE intidmensaje = $codigo";
							...
							<div class="panel-body">
								<form action="" method="post">
								  <div class="form-group">
								    ...
								    <input type="text" class="form-control" id="mensaje" name="mensaje" aria-describedby="emailHelp" placeholder="Ingresar mensaje personalizado" value="'.$row['nvchmensaje'].'" required="true">
								  ...
								  <a href="mensaje.php" class="btn btn-xs btn-danger">Regresar</a>
								</form>
							</div>
...
<?php
	if(isset($_POST['actualizar'])){
		...
		$sql = "UPDATE tb_mensaje SET nvchmensaje='$mensaje' WHERE intidmensaje = ".$codigo."";
