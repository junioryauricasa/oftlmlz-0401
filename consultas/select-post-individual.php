	       	...
	       	echo '
				<article>
					<div class="row">
						...
						<div class="bottom-article col-md-8">
							<!--ul class="meta-post">
							...
							<a href="post?public='.$row["nvchtituloblog"].'&codigo='.$row["indidblog"].'" class="pull-right btn btn-danger">Continuar Leyendo <i class="icon-angle-right"></i></a>
						</div>
					</div>
